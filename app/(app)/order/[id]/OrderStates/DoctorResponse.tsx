...
import { IBaseOrder, IDoctorResponse } from "../types";
...
export default function DoctorResponse({ data }: { data: IDoctorResponse }) {
  return (
        ...
        items={[
          {
            ...
            children: (
              <div className="flex flex-row justify-around items-center">
                <FootImage feetUrl={data.images.RIGHT.FRONT} />
                <FootImage feetUrl={data.images.RIGHT.BACK} />
              </div>
            ),
          },
          {
...
function FootImage({ feetUrl }: { feetUrl: string }) {
