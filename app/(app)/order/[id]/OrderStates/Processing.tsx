...
export default function Processing({ data }: { data: IBaseOrder }) {
  return (
    <section className="relative bg-gradient-to-b from-white-primary from-10% via-white to-100% to-primary-3 overflow-scroll">
      ...
      <div className="px-14 pt-6 flex flex-col justify-center gap-4">
        ...
        <p dir="rtl" className="text-xs font-normal  text-center leading-7">
          اطلاعات شما دریافت شده است و درحال پردازش توسط هوش مصنوعی و بررسی
          نهایی تیم تخصصی فیزیوتراپیست های ما می باشد، این پروسه حداکثر ۲۴ ساعت
          زمان میبرد. از صبر و شکیبایی شما متشکریم.
        </p>
      </div>
