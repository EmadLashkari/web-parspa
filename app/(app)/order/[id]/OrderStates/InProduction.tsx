...
import doctor from "@/public/image/working.png";
...
export default function InProduction({ data }: { data: IProduction }) {
  return (
    <section className="relative bg-gradient-to-b from-white-primary from-10% via-white to-100% to-primary-3 overflow-scroll">
      ...
      <div className="px-14 pt-6 flex flex-col justify-center gap-4">
        <h1 dir="rtl" className="text-xl font-bold text-center">
          طراحی و تولید کفی منحصر به فرد پارس پا
        </h1>
        <p dir="rtl" className="text-xs font-normal  text-center leading-7">
          تیم تخصصی طراحی و تولید کفی پارس پا درحال طراحی و تولید سفارش شما
          میباند، این پروسه حداکثر سه روز کاری از زمان ثبت درخواست شما زمان
          میبرد .برای هرگونه اطلاعات بیشتر میتوانید با تیم پشتیبانی پارس پا در
          ارتباط باشید.
        </p>
      </div>
